...
full-path-to-bulk-RNAseq-folder-on-Garibaldi (parent folder)
├── fastqs/ (the sample  fastqs can be located anywhere on Garibaldi)
├── samplesheet.csv
├── results/ (generated by the RNA-seq pipeline, do not rename this folder)
├── contrasts.csv (do not rename this file)
├── sample sheet_de.csv (do not rename this file)
├── DE_results/ (this is the output folder generated by the differential abundance pipeline)
...
*  Click on the “Input Data” tab. In the text box, 
   ...
   * (b) type in the full path to your folder on Garibaldi where you generated the files for your dataset using instructions in **Step1**: “samplesheet_de.csv” and “contrast.csv”.
